...
{
    private $_table = "kerajinan_desa";

    public $id;
    public $nama_kerajinan;
    public $lokasi_pembuatan;
    public $harga;
    ...
    public function rules()
    {
        return [
            ...
            [
                'field' => 'nama_kerajinan',
                'label' => 'nama_kerajinan',
                'rules' => 'required'
            ],
    ...
    {
        $query = $this->db->query("SELECT * FROM kerajinan_desa ");
        return $query->result();
    }
    ...
    public function save()
    {
        ...
        $this->nama_kerajinan = $post["nama_kerajinan"];
        $this->lokasi_pembuatan = $post["lokasi_pembuatan"];
    ...
    {
        $config['upload_path']          = './assets/img/foto_kerajinan/';
