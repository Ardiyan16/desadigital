                ...
                <?php foreach ($berita as $ber) : ?>
                    <article>
                        <div class="article-img">
                            <a href="<?php echo site_url('user/Homeuser/fpberitauser/' . $ber->id_berita) ?>">
                        ...
                        <div class="article-body">
                            ...
                            <h5 class="article-title"><a href="<?php echo site_url('user/Homeuser/fpberitauser/' . $ber->id_berita) ?>" name="judulberita"><?= $ber->judul_berita ?></a></h5>
