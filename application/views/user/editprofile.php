...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <section class="edit-profile">
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 mt-4 text-gray-800">Edit Profile</h1>


            <div class="row">
                <div class="col-lg-8">

                    <?= form_open_multipart('user/Homeuser/editprofile'); ?>
                    <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Username</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="email" name="username" value="<?= $pengguna['username']; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-3">
                                    <img src="<?= base_url('assets/img/foto_profile/') . $pengguna['foto']; ?>" class="img-thumbnail">
                                </div>
                                <div class="col-sm-9">
