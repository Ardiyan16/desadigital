                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header">
                                ...
                                <h3 class="box-title" style="margin-bottom: 20px;">Edit Event
                                    <small>Tambahkan Event Desa</small>
                                </h3>
                                <div class="box-body">
                                    <form action="<?= site_url('admin/Event/editan'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            judul event<input type="text" class="form-control" name="judul_event" placeholder="Judul Event..." value="<?php echo $event->judul_event ?>">
                                        </div>
                                        <div class="form-group">
                                            <div>
                                                isi event<textarea id="editor1" name="isi_event" rows="10" cols="80" placeholder="Isi Berita..."><?php echo $event->isi_event ?></textarea>
                                            </div>
                                        </div>
                                        <br />
                                        <div class="form-group">
                                            foto<input type="file" name="foto" class="form-control">
                                            <img src="<?php echo base_url('assets/img/foto_event/' . $event->foto) ?>" width="100" height="100">
                                        </div>
                                        <div class="form-group">
                                            tanggal mulai<input type="date" class="form-control" value="<?php echo $event->tanggal_selesai ?>" name="tanggal_mulai" placeholder="Subject">
                                        </div>
                                        <div class="form-group">
                                            tanggal selesai<input type="date" value="<?php echo $event->tanggal_selesai ?>" class="form-control" name="tanggal_selesai" placeholder="Subject">
                                        </div>
                                        <div class="form-group">
                                            Dusun
